...
for(var val in teamModelLis ){
  ...
  factory ProjectD.fromJson(Map<String, dynamic> json) {
    ...
    return ProjectD(deadline: checkNull(data: json["deadline"], title: "deadline") , id: checkNull(data: json["id"], title: "id"), name:  checkNull(data: json["name"], title: "name"), teamModelLis:tempList );
