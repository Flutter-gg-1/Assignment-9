import 'package:assignment_9/helpers/color_print.dart';

import '../lib/database/model.dart';
...
void main() {
  ...
  try {
    ...
    final marketingEmployees = getMarketingEmployees(companyData);
    final engineeringEmployees = getEngineeringEmployees(companyData);
    final employeeProjects = getEmployeeProjects(companyData);
    final budgetExpenses = getBudgetExpenses(companyData);

    printInfo('Marketing Employees:\n $marketingEmployees');
    printInfo('Engineering Employees:\n $engineeringEmployees');
    printInfo('Employee Projects: \n$employeeProjects');
    printInfo('Budget Expenses: \n$budgetExpenses');
  } catch (e) {
